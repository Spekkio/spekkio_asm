...
as: as.c $(objects) parse.h encode.h setup_regex.h
	gcc $(optimize) $(flags) $(std) -o as as.c $(objects) $(libs)

parse.o: parse.c parse.h encode.h setup_regex.h smallfunc.h
	gcc $(optimize) $(flags) $(std) -c parse.c

encode.o: encode.c parse.h encode.h
	gcc $(optimize) $(flags) $(std) -c encode.c

setup_regex.o: setup_regex.c parse.h setup_regex.h
	gcc $(optimize) $(flags) $(std) -c setup_regex.c

smallfunc.o: smallfunc.c  parse.h smallfunc.h
	gcc $(optimize) $(flags) $(std) -c smallfunc.c

assemble.o: assemble.c assemble.h parse.h encode.h smallfunc.h
